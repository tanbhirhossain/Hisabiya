...
<template>
    ...
    >
        <div
            ...
            :class="type === 'success'
                ? 'border-emerald-200 bg-white text-emerald-800 dark:border-emerald-500/30 dark:bg-emerald-950 dark:text-emerald-300'
                : 'border-rose-200 bg-white text-rose-800 dark:border-rose-500/30 dark:bg-rose-950 dark:text-rose-300'"
            role="status"
        >
